...
const highlightCards = [
  {
    icon: HiAcademicCap,
    title: "Education",
    desc: "Faculty of Electronic Engineering — Computer Science Department",
  },
  {
    icon: HiBriefcase,
    title: "Freelance Work",
    desc: "30+ Completed Web & Full-Stack Projects",
  },
  {
    icon: HiLocationMarker,
    title: "Location",
    desc: "Egypt — Available for Global Remote Opportunities",
  },
];
  ...
  return (
    <SectionWrapper id="about">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Narrative & Technical Versatility */}
          ...
          <GlassCard className="h-full p-8 border border-[#585A68]/30 flex flex-col justify-between" delay={0.2}>
            <div className="space-y-4">
              ...
              <p className="text-text-muted text-sm leading-relaxed">
                I’m a <strong className="text-[#7C3AED]">Full-Stack Developer</strong> focused on building modern, scalable, and user-centered web applications. I hold a degree from the <strong className="text-text-main">Faculty of Electronic Engineering — Computer Science Department</strong> in Egypt.
              </p>

              <p className="text-text-muted text-sm leading-relaxed">
                My journey began primarily in the <strong className="text-text-main">Frontend/React</strong> space, building responsive interfaces and interactive web experiences. Over time, I expanded into full-stack architecture — mastering RESTful APIs, authentication systems (JWT, AWS Cognito), database design (<strong className="text-text-main">PostgreSQL, MongoDB, Prisma</strong>), and cloud deployments.
              </p>
              ...
              <div className="pt-4 border-t border-[#585A68]/30 bg-[#7C3AED]/5 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  <HiLightningBolt className="text-[#7C3AED] text-xl flex-shrink-0 mt-0.5" />
                  <div>
                    <h4 className="text-xs font-bold text-text-main uppercase tracking-wider mb-1">
                      Currently Exploring & Developing
                    </h4>
                    <p className="text-xs text-text-muted leading-relaxed">
                      Microservices Architecture, SOLID Principles, Performance Optimization (LCP, CLS, INP), and AI-enhanced web application capabilities.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {ecosystemStack.map((tech, i) => (
                  <GlassCard
                    key={tech.label}
                    className="flex items-center gap-3 !p-3.5 border border-[#585A68]/20 hover:border-[#7C3AED]/50"
                    hover
                    delay={0.1 + i * 0.04}
                  >
                    <tech.icon className="text-2xl flex-shrink-0 text-[#7C3AED]" />
                    <div className="overflow-hidden">
                      <p className="text-text-main text-xs font-bold truncate">
                        {tech.label}
                      </p>
                      <p className="text-[10px] text-[#6C6E7E] truncate">
                        {tech.category}
                      </p>
                    </div>
                  </GlassCard>
