  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      cards?.forEach((card, i) => {
        ...
        gsap.set(card, { opacity: 0, x: fromLeft ? -80 : 80, scale: 0.95 });
        gsap.to(card, {
      ...
      if (line) {
        ...
        gsap.to(line, {
          ...
          scrollTrigger: { trigger: timelineRef.current, start: "top 88%", toggleActions: "play none none none" },
        });
      }
    ...
    <SectionWrapper id="experience">
      <div className="max-w-5xl mx-auto">
        ...
        <div ref={timelineRef} className="relative">
          ...
          <div className="timeline-line absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-0.5 bg-linear-to-b from-[#7C3AED] via-[#6366F1] to-transparent hidden md:block" />
            ...
            {experiences.map((exp, i) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Center dot */}
                  <div className="timeline-dot hidden md:flex absolute left-1/2 -translate-x-1/2 w-5 h-5 rounded-full bg-linear-to-br from-[#7C3AED] to-[#6366F1] border-2 border-[#0B0914] shadow-lg shadow-[#7C3AED]/40 items-center justify-center z-10">
